...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { location: @park.location, name: @park.name, neighborhood: @park.neighborhood, park_url: @park.park_url } }
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { location: @park.location, name: @park.name, neighborhood: @park.neighborhood, park_url: @park.park_url } }
